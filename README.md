...
**Week 3** (Sept. 20, 1:00 pm - 3:30 pm) *Topic*: [Version Control and
...
**Week 4** (Sept. 27, 1:00 pm - 3:30 pm)  
...
**Week 5** (Oct. 4, 1:00 pm - 3:30 pm) *Topic*: [Data Management Plans
(DMP):
